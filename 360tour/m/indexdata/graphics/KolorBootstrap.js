...
function eventKrpanoLoaded (isWebVr) {
	...
	addKolorArea('description16');
addKolorArea('description15');
addKolorArea('description14');
addKolorArea('description13');
addKolorArea('description12');
addKolorArea('description11');
addKolorArea('description10');
addKolorArea('description9');
addKolorArea('description8');
addKolorArea('description7');
addKolorArea('description6');
addKolorArea('description5');
addKolorArea('description4');
...
deleteKolorArea('description4');
deleteKolorArea('description5');
deleteKolorArea('description6');
deleteKolorArea('description7');
deleteKolorArea('description8');
deleteKolorArea('description9');
deleteKolorArea('description10');
deleteKolorArea('description11');
deleteKolorArea('description12');
deleteKolorArea('description13');
deleteKolorArea('description14');
deleteKolorArea('description15');
deleteKolorArea('description16');
